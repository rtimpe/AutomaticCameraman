...
//for( int ii=0; ii<posx.size(); ++ii ) printf("pos val: %f (%d,%d)\n", _weakclf[m]->getFtrVal(posx,ii), posx[ii]._col - 127, posx[ii]._row - 81);
//for( int ii=0; ii<negx.size(); ++ii ) printf("neg val: %f (%d,%d)\n", _weakclf[m]->getFtrVal(negx,ii), negx[ii]._col - 127, negx[ii]._row - 81);
	}
